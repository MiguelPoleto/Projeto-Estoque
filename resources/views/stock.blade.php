...
<main class="stock-management">
    <div class="container-fluid p-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 section-header">
            <h3 class="mb-0 page-title">Gestão de Estoque</h3>
            <div class="action-buttons">
                <button class="btn btn-primary btn-with-icon" data-bs-toggle="modal" data-bs-target="#addProductModal">
                    <i class="fas fa-plus-circle"></i> Adicionar Produto
                </button>
                <button class="btn btn-success btn-with-icon" data-bs-toggle="modal" data-bs-target="#buyProductModal">
                    <i class="fas fa-shopping-cart"></i> Compra
                </button>
                <button class="btn btn-danger btn-with-icon" data-bs-toggle="modal" data-bs-target="#sellProductModal">
                    <i class="fas fa-dollar-sign"></i> Venda
                </button>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-category">
                                ...
                                @case('eletronic') Eletrônicos @break
                                @case('furniture') Móveis @break
                                @case('raw_material') Vestuário @break
                                @case('others') Outros @break
                                @endswitch
                            </span>
                        </td>
                        ...
                        <td>
                            <span class="badge {{ $product->is_active == 1 ? 'badge-active' : 'badge-inactive' }}">
                        ...
                        <div class="tab-pane fade show active" id="basic-info" role="tabpanel" aria-labelledby="basic-info-tab">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Digite o nome do produto" maxlength="16" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                        ...
                        <div class="tab-pane fade show active" id="edit-basic" role="tabpanel">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="edit-name" name="name" maxlength="16" required>
                                </div>
                                <div class="col-md-6">
